...
const EMPTY_SNAPSHOT: GameSnapshot = { mode: "title", ending: null, chapter: 1, age: 38, clarity: 100, clarityLabel: "くっきり読める", vigor: 22, maxVigor: 22, turns: 0, tsundoku: [], memory: [], aids: [], activeBook: null, activeBookCarried: false, pendingAbility: null, canRest: false, specialReady: [], log: ["棚の隙間に、まだ読んでいない夜がある。"], score: 120, routeHint: null, finalNote: null };
